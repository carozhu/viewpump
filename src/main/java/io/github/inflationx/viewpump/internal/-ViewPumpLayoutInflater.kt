...
internal class `-ViewPumpLayoutInflater`(
    ...
    private val IS_AT_LEAST_Q =
        Build.VERSION.SDK_INT > Build.VERSION_CODES.P || BuildCompat.isAtLeastQ()
     ...
     */
    private open class WrapperFactory2(factory2: LayoutInflater.Factory2) :
    ...
    private class PrivateWrapperFactory2ViewCreator(
        ...
        override fun onCreateView(
            ...
            return inflater.createCustomViewInternal(
                attrs?.let { factory2.onCreateView(parent, name, context, it) },
                name,
                context,
                attrs)
        }
